...
public class DetalleConsumo {
  ...
  private ArrayList<RangoConsumo> arrayrangoconsumo;

    public ArrayList<RangoConsumo> getArrayrangoconsumo() {
        return arrayrangoconsumo;
    }

    public void setArrayrangoconsumo(ArrayList<RangoConsumo> arrayrangoconsumo) {
        this.arrayrangoconsumo = arrayrangoconsumo;
    }
